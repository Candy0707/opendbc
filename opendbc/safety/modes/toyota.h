...
#define TOYOTA_COMMON_TX_MSGS                            \
  TOYOTA_BASE_TX_MSGS{0x2E4, 0, 5, .check_relay = true}, \
      {0x343, 0, 8, .check_relay = false}, /* ACC cancel cmd */

#define TOYOTA_COMMON_SECOC_TX_MSGS                                                          \
  TOYOTA_BASE_TX_MSGS{0x2E4, 0, 8, .check_relay = true}, {0x131, 0, 8, .check_relay = true}, \
      {0x343, 0, 8, .check_relay = false}, /* ACC cancel cmd */

#define TOYOTA_COMMON_LONG_TX_MSGS                                                                                                                                                                         \
  TOYOTA_COMMON_TX_MSGS /* DSU bus 0 */                                                                                                                                                                    \
      {0x283, 0, 7, .check_relay = false},                                                                                                                                                                 \
      {0x2E6, 0, 8, .check_relay = false}, {0x2E7, 0, 8, .check_relay = false}, {0x33E, 0, 7, .check_relay = false},                                                                                       \
      {0x344, 0, 8, .check_relay = false, .disable_static_blocking = true}, {0x365, 0, 7, .check_relay = false}, {0x366, 0, 7, .check_relay = false}, {0x4CB, 0, 8, .check_relay = false}, /* DSU bus 1 */ \
      {0x128, 1, 6, .check_relay = false}, {0x141, 1, 4, .check_relay = false}, {0x160, 1, 8, .check_relay = false}, {0x161, 1, 7, .check_relay = false},                                                  \
      {0x470, 1, 4, .check_relay = false}, /* PCS_HUD */                                                                                                                                                   \
      {0x411, 0, 8, .check_relay = false}, /* radar diagnostic address */                                                                                                                                  \
      {0x750, 0, 8, .check_relay = false}, /* ACC */                                                                                                                                                       \
      {0x343, 0, 8, .check_relay = true},

#define TOYOTA_COMMON_SECOC_LONG_TX_MSGS                         \
  TOYOTA_COMMON_SECOC_TX_MSGS{0x343, 0, 8, .check_relay = true}, \
...
#define TOYOTA_RX_CHECKS(lta)                                                                                               \
  TOYOTA_COMMON_RX_CHECKS(lta){.msg = {{0x1D2, 0, 8, 33U, .ignore_counter = true, .ignore_quality_flag = true}, {0}, {0}}}, \
...
#define TOYOTA_SECOC_RX_CHECKS                                                                                                \
  TOYOTA_COMMON_RX_CHECKS(false){.msg = {{0x176, 0, 8, 32U, .ignore_counter = true, .ignore_quality_flag = true}, {0}, {0}}}, \
...
static bool toyota_tx_hook(const CANPacket_t *msg)
{
  ...
  static const AngleSteeringLimits TOYOTA_ANGLE_STEERING_LIMITS = {
      ...
      .angle_rate_up_lookup = {
          {5., 25., 25.},
          {0.3, 0.15, 0.15}},
      .angle_rate_down_lookup = {{5., 25., 25.}, {0.36, 0.26, 0.26}},
  };
...
static safety_config toyota_init(uint16_t param)
{
  ...
  static const CanMsg TOYOTA_INTERCEPTOR_TX_MSGS[] = {
      TOYOTA_COMMON_LONG_TX_MSGS{0x200, 0, 6, .check_relay = false}, // gas interceptor
  };
