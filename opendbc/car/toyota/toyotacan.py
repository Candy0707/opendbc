...
def create_lta_steer_command(packer, stock_steering_lta, steer_angle, steer_req, frame, torque_wind_down):
  """Creates a CAN message for the Toyota LTA Steer Command."""

  values = {s: stock_steering_lta[s] for s in [
    "STEER_REQUEST",
    "COUNTER",
    "SETME_X1",
    "STEER_ANGLE_CMD",
